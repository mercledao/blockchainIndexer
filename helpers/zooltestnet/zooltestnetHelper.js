...
const indexDataBatch = async (txns) => {
  try {
    ...
    rdl = new ethers.Contract("0xC98AE786cAB90E2F6C8E39D13af19193931f40FF", RdlAbi, cacheHelper.zooltestnet.wallet);
    ...
    const formatted = txns.map((txn) => {
      return {
        ...
        amountUsd: ethers.utils.parseUnits(parseFloat(txn.amountUsd.toString()).toFixed(6), 6),
